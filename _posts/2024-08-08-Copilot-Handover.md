...
This guide will walk you through the process of setting up a customer service Copilot from scratch. The steps involved are:
1. **Provisioning a Dynamics 365 Customer Service Trial**
2. **Creating Necessary Dataverse Tables**
3. **Setting Up Azure AI Language Service for Sentiment Analysis**
4. **Configuring the Copilot in Copilot Studio and setting up the handover**
